...
@WebServlet("/PlayerUpload")
public class PlayerUpload extends HttpServlet {
			  ...
			  String uploadPath = 
					  ...
					  while (items.hasMoreElements()){
					  	...
					  	for(int i=0 ; i<4;i++){
					  		...
					  		String destFilename = "C:\\Users\\WeiZiChang\\eclipse-workspace\\HitoBaseBall\\WebContent\\upload\\"+id+"_"+i+"_slides.png"; 
